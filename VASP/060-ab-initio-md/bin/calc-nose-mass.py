# Main Author : http://staff.ustc.edu.cn/~zqj/
# Modified by : Arun Jangir arun.jangir@kaust.edu.sa
...
def parse_cml_args(cml):
    ...
    arg.add_argument('-f', '--frequency', dest='frequency',
                     action='store', type=float,
                     default=40,
                     help="""if unit=fs, Provide Time Period of oscillation
                     else if unit=cm-1 Provide Frequency of oscilation in cm-1""")
