...
strainAxisLabel="Y" # Polarization along X or Y Axis

polAxisMarker=$((5+$polAxis))
outFile="polarization.csv"

echo "strainAxisLabel, polAxis, epsilon, pIon, pEle, vol, a, b, c, shift" > ${outFile}
echo "#Char, Integer, Float, e*Angst, e*Angst, Ang^3, Ang, Ang, Ang, Integer" >> ${outFile}
...
for strain in $strains; do
    ...
    echo "$strainAxisLabel, $polAxis, $strain, $pIon, $pEle, $vol", $cellVectors, 0 >> ${outFile}
done
