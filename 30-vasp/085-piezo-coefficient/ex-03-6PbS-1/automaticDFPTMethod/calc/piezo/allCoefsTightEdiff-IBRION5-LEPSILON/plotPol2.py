...
with open("OUTCAR",'r') as fd:
    lines = fd.readlines()
#    clampedMarker = lines.index(" PIEZOELECTRIC TENSOR  for field in x, y, z        (C/m^2)\n")
    ionicContrMarker = lines.index(" PIEZOELECTRIC TENSOR (including local field effects)  for field in x, y, z        (C/m^2)\n")
...
piezoTensor = (piezoTensorIonRlxContribution)*c
