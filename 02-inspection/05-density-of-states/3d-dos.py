...
n = np.arange(1, maxN)
nxs, nys, nzs = np.meshgrid(n, n, n, indexing='ij')
energies = nxs**2 + nys**2 + nzs**2
...
plt.scatter(energy_mids, dos_counts, color='teal', alpha=0.5, label='Numerical Data (3D)')
...
plt.title('Numerical 3D Density of States and Polynomial Fit')
plt.legend()
