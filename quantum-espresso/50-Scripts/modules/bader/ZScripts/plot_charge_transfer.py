...
print(data)
ax1.plot(data[:,0]*514.22*11/8,data[:,2]+data[:,3],".-",label=r"Charge top")  
ax1.plot(data[:,0]*514.22*11/8,data[:,1]+data[:,4],".-",label=r"Charge bottom")  
...
ax1.legend()
plt.tight_layout()
plt.savefig("../chargeTransfer.svg")
plt.show()
