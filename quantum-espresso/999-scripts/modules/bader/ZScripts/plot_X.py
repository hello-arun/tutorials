...
print(data)
ax1.plot(data[:,0]*514.22*11/8,data[:,3],".-",label=r"$\mathregular{X_T}$")  #Bottomw
ax1.plot(data[:,0]*514.22*11/8,data[:,4],".-",label=r"$\mathregular{X_B}$")  
# ax[1].plot(data[:,0]*514.22*11/8,data[:,4],label="S_B")
# ax[1].plot(data[:,0]*514.22*11/8,data[:,3],label="S_T")
ax1.legend()
plt.tight_layout()
plt.savefig("../chargeX.svg")
plt.show()
